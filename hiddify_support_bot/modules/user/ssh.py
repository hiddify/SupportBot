...
async def done(msg: HMessage):
    ...
    await bot.send_message(msg.chat_id, f'{msg_info} {_("ssh.done", msg.lang)} {out_res}', reply_parameters=types.ReplyParameters(msg.main_message.id), parse_mode='markdown')
