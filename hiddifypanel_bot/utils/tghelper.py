...
def format_user_message_from_admin(msg,user_data):
        ...
        if last_online_display :
            ...
            user_data['last_online_relative']=format_timedelta(time_diff,msg.lang,granularity="minutes"  )
        ...
        if start_date:
            user_data['start_date_relative']=format_timedelta(time_diff,msg.lang,granularity="days"  )
            user_info = _("userinfo_started", msg.lang,
                          **user_data
                        )  
        else:
            user_info = _("userinfo_started", msg.lang,**user_data)
